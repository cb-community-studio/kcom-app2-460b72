...
import BorrowhistoryPage from "../components/BorrowhistoryPage/BorrowhistoryPage";
import SingleBorrowhistoryPage from "../components/BorrowhistoryPage/SingleBorrowhistoryPage";
// ~cb-add-import~
        ...
        <div className={wrapperClass} onClick={onWrapperClick}>
            ...
            <MainLayout>
                <Switch>
                    ...
                    <Route path="/books/:singleBooksId" component={SingleBooksPage} exact />
                    <Route path="/borrowhistory" component={BorrowhistoryPage} exact />
                    <Route path="/borrowhistory/:singleBorrowhistoryId" component={SingleBorrowhistoryPage} exact />
                    {/* ~cb-add-route~ */}
